...
const contractorFormSchema = z.object({
  ...
  fleetMotorcycles: z.number().min(0).default(0),
  fleetCars: z.number().min(0).default(0),
  fleetVans: z.number().min(0).default(0),
  fleetTrucks: z.number().min(0).default(0),
  totalDrivers: z.number().min(1, "Number of drivers is required"),
...
const Logo = () => (
  <a href="/" className="flex items-center gap-3 font-heading font-bold text-2xl tracking-tight">
    <div className="relative flex items-center justify-center w-12 h-12 bg-gradient-to-br from-primary via-orange-500 to-yellow-500 rounded-xl text-white shadow-2xl">
